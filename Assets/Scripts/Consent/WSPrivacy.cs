...
namespace EasyMobile.WSConsent
{
    public class WSPrivacy : MonoBehaviour
    {
        ...
        public const string AltTitle = "Consentement";

        // The first paragraph of the dialog content in French
        public const string AltFirstParagraph = "Cette application recueille certaines informations sur votre utilisation de notre application que nous aimerions que vous utilisiez à des fins de publicité, d'analyse et de notification. " +
                                               "Nous suivons strictement notre <a href=\"" + westslothPolicyURL + "\">Privacy Policy</a> " +
        ...
        public const string AltSecondParagraph = "BLAA-BLAA\n";

        public const string AltThirdParagraph = "Blaa-Blaa-Blaa\n";

        // The title of the toggle for the Advertising module consent in French
        public const string AltAdsToggleTitle = "La publicité";

        // The On description of the toggle for the Advertising module consent in French
        public const string AltAdsToggleOnDesc = "Vous recevrez des annonces pertinentes! " +
        ...
        public const string AltAdsToggleOffDesc = "Nos fournisseurs d'annonces collecteront des données et utiliseront un identifiant unique sur votre appareil pour vous montrer les annonces pertinentes. " +
        ...
        public const string AltNotifsToggleTitle = "Les notifications";

        // The common description (both On & Off states) of the toggle for the Notifications module consent in French
        public const string AltNotifsToggleDesc = "Notre fournisseur de services, OneSignal, collectera des données et utilisera un identifiant unique sur votre appareil pour vous envoyer des notifications push. " +
        ...
        public const string AltAnalyticsToggleTitle = "Analytique*";

        // The common description (both On & Off states) of the toggle for Unity Analytics consent in French
        public const string AltAnalyticsToggleDesc = "Nous utilisons le service Unity Analytics pour collecter certaines informations analytiques nécessaires à l'amélioration de cette application. " +
        ...
        public const string AltAnalyticsToggleUnavailDesc = "Nous utilisons le service Unity Analytics pour collecter certaines informations analytiques nécessaires à l'amélioration de cette application. " +
        ...
        // The button title in English.
        public const string AltButtonTitle = "Acceptez";
        ...
        private static ConsentDialog mConsentDialog;
        private static ConsentDialog mConsentDialogLocalized;
        ...
        public static void ShowConsentDialog(bool localize, bool dismissible)
        {
            if (localize)
            {
                if (mConsentDialogLocalized == null)
                {
                    mConsentDialogLocalized = ConstructConsentDialog(localize);
                    SubscribeConsentDialogEvents(mConsentDialogLocalized);
                }
                mConsentDialogLocalized.Show(dismissible);
            }
            else
            {
                if (mConsentDialog == null)
                {
                    mConsentDialog = ConstructConsentDialog(localize);
                    SubscribeConsentDialogEvents(mConsentDialog);
                }
                mConsentDialog.Show(dismissible);
            }
        }
        ...
        private static ConsentDialog ConstructConsentDialog(bool localize)
        {
            ...
            // Title.
            dialog.Title = localize ? AltTitle : EnTitle;

            // Put our disclaimer on top.
            //dialog.AppendText(Disclaimer);

            // Add the first paragraph.
            dialog.AppendText(localize ? AltFirstParagraph : EnFirstParagraph);
            dialog.AppendText(localize ? AltFirstParagraph : EnSecondParagraph);
            dialog.AppendText(localize ? AltFirstParagraph : EnThirdParagraph);


            // Build and append the Advertising toggle.
            ConsentDialog.Toggle adsToggle = new ConsentDialog.Toggle(AdsToggleId);
            adsToggle.Title = localize ? AltAdsToggleTitle : EnAdsToggleTitle;
            adsToggle.OnDescription = localize ? AltAdsToggleOnDesc : EnAdsToggleOnDesc;
            adsToggle.OffDescription = localize ? AltAdsToggleOffDesc : EnAdsToggleOffDesc;
            ...
            //notifsToggle.Title = localize ? AltNotifsToggleTitle : EnNotifsToggleTitle;
            //notifsToggle.OnDescription = localize ? AltNotifsToggleDesc : EnNotifsToggleDesc;
            ...
            if (!string.IsNullOrEmpty(unityAnalyticsOptOutURL))
            {
                ...
                var description = localize ? AltAnalyticsToggleDesc : EnAnalyticsToggleDesc;
            ...
            else
            {
                ...
                uaToggle.OnDescription = localize ? AltAnalyticsToggleUnavailDesc : EnAnalyticsToggleUnavailDesc;
            }
            ...
            okButton.Title = localize ? AltButtonTitle : EnButtonTitle;
