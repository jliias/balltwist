...
namespace EasyMobile.Consent
{
    ...
    public class TestAppConsent
    {
        ...
        public static void ApplyAppConsent(TestAppConsent consent)
        {
        ...
        /// </summary>
        /// <param name="consent">Consent.</param>
        public static void SaveAppConsent(TestAppConsent consent)
        {
            if (consent != null)
        ...
        public static TestAppConsent LoadAppConsent()
        {
            string json = PlayerPrefs.GetString(DemoStorageKey, null);

            if (!string.IsNullOrEmpty(json))
                return JsonUtility.FromJson<TestAppConsent>(json);
            else
                return null;
        }
    }
